...
abstract TypedExprOrString(ITypedExprOrString) {
	...
	@:from public static function fromTypedExpression(expr: TypedExpr) return new TypedExprOrString(expr);
	@:from public static function fromString(s: String) return new TypedExprOrString(s);
